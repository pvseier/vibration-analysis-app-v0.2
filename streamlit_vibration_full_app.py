...
if uploaded_file is not None:
    ...
    st.sidebar.header("Graph Title")
    graph_title = st.sidebar.text_input("Graph Title", value="Filtered Velocity (DC Offset Removed)")
    ...
    ax1.plot(df_view['Time_s'], df_view['DC_Free_Velocity_X'], label='X')
    ax1.plot(df_view['Time_s'], df_view['DC_Free_Velocity_Y'], label='Y')
    ax1.plot(df_view['Time_s'], df_view['DC_Free_Velocity_Z'], label='Z')
    ...
    ax2.set_title("FFT of DC-Free Velocity")
